# Agent instructions for 01-project-foundation

Objective: Create the modular Kotlin/Compose Android project and establish build architecture, package conventions, and test foundations.
