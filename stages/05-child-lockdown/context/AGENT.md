# Agent instructions for 05-child-lockdown

Objective: Implement Child Mode lockdown using Lock Task Mode and Device Owner policies, then document the enforced security boundary.
